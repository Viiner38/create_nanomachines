...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    @Override
        protected void registerModels() {
            ...
            handheldItem(ModItems.NANOMACHINES_STEELSWORD);
            handheldItem(ModItems.NANOMACHINES_STEELSHOVEL);

            trimmedArmorItem(ModItems.NANOMACHINES_STEELHELMET);
            trimmedArmorItem(ModItems.NANOMACHINES_STEELCHESTPLATE);
            trimmedArmorItem(ModItems.NANOMACHINES_STEELLEGGINGS);
            trimmedArmorItem(ModItems.NANOMACHINES_STEELBOOTS);

    }

    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Nanomachines.MOD_ID;
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                new ResourceLocation(Nanomachines.MOD_ID,"item/" + item.getId().getPath()));
    }
